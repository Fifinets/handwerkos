    ...
    Tables: {
      ...
      company_settings: {
        Row: {
          ...
          reminder_days_1: number | null
          reminder_days_2: number | null
          reminder_days_3: number | null
      ...
      employee_push_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_push_tokens_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_push_tokens_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      equipment_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "equipment_assignments_device_id_fkey"
            columns: ["device_id"]
            isOneToOne: false
      ...
      invoices: {
        ...
        Relationships: [
          {
            foreignKeyName: "invoices_agent_task_id_fkey"
      ...
      offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "offers_agent_task_id_fkey"
            columns: ["agent_task_id"]
            isOneToOne: false
            referencedRelation: "agent_tasks"
            referencedColumns: ["id"]
      ...
      orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "orders_agent_task_id_fkey"
            columns: ["agent_task_id"]
            isOneToOne: false
            referencedRelation: "agent_tasks"
            referencedColumns: ["id"]
