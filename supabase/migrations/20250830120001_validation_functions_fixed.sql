-- Validation Functions and Business Logic - Phase 2 (Fixed)
    ...
    WITH matches AS (
        SELECT 
            ...
            CASE
                ...
                -- Name similarity (fallback without similarity function)
...
-- 5. Duplicate detection function (FIXED - removed duplicate column)
