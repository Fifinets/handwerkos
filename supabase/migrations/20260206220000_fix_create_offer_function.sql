-- Fix create_offer_with_targets function to robustly handle company_id
-- This repeats the update from 20260206_add_offer_content_fields.sql to ensure it is applied
